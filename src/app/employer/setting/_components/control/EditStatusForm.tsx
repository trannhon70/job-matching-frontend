...
import { UpdateEmployerStatusType } from "@/types/employer/setting";
...
export const EditStatusForm: React.FC<Props> = ({
  ...
  const { updateEmployerStatus } = useEmployerApi();
  const mutation = useMutation({
    mutationFn: (body: UpdateEmployerStatusType) => {
      return updateEmployerStatus(+userId, body);
    },
    onSuccess: (res) => {
              ...
              <FormControl>
                ...
                >
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">Approval</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
