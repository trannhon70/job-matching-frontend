...
import { getCompanySelect } from "@/services/apis/select";
...
export const CompanySelect: React.FC<Props> = ({ onChange, value }) => {
  ...
  const { isLoading, data } = useQuery({
    queryKey: [SelectKeys.COMPANY],
    queryFn: () => {
      return getCompanySelect();
    },
  });
